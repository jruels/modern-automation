...
1. Create a new request to `https://httpbun.org/basic-auth/user/pass`
...
# Basic Authentication
response = requests.get(
    'https://httpbun.org/basic-auth/user/pass',
    auth=('user', 'pass')
)
...
#### Bearer Token
**Postman:**
1. Create a new request to `https://httpbun.org/bearer`
...
#### API Key
**Postman:**
1. Create a new request to `https://httpbun.org/headers`
