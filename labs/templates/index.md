...
7. Go back to the inventory Groups tab and click **Create group** to create the `database` group:
   * **Name**: `database`
   * **Description**: `Database servers group`
8. Click **Create group**
9. In the `database` group, click the **Hosts** tab, click **Add host**, then choose **Add existing host**
10. Select the second node from your inventory and click **Confirm**
...
1. Click the **Launch template** button on your `deploy_hardened_sudoers-[your initials]` template
...
5. Click **Run command**. This opens a four-step wizard.
...
* Confirm the values, then click **Finish**.
...
1. Run another ad-hoc command using the **Run command** wizard:
   * **Module**: `setup`
